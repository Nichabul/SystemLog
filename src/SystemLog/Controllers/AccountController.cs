    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var SignInUser = await _userManager.FindByEmailAsync(model.Email);
                if (SignInUser == null)
                {
                    SignInUser = await _userManager.FindByNameAsync(model.Email);
                }
                if (SignInUser == null)
                {
                ...
                var result = await _signInManager.PasswordSignInAsync(SignInUser, model.Password, model.RememberMe, lockoutOnFailure: false);
                if (result.Succeeded)
                {
        ...
        public IActionResult Register(string returnUrl = null)
        {
            ...
            //_roleManager.CreateAsync(new IdentityRole("Supervisor"));
